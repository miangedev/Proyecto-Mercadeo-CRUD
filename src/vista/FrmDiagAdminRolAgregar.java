...
public class FrmDiagAdminRolAgregar extends javax.swing.JDialog {

    rol objRolAdd;

    public FrmDiagAdminRolAgregar(java.awt.Frame parent, boolean modal, rol obj) {
        super(parent, modal);
        initComponents();
        this.objRolAdd = obj;
    }
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtNombreRol, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        this.objRolAdd.setRol(this.txtNombreRol.getText());
        this.dispose();
    }
