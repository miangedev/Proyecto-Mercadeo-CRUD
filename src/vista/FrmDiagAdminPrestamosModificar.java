...
public class FrmDiagAdminPrestamosModificar extends javax.swing.JDialog {

    prestamosactivopersonas objPrestamoMod;

    public FrmDiagAdminPrestamosModificar(javax.swing.JFrame parent, boolean modal, prestamosactivopersonas obj) {
        super(parent, modal);
        initComponents();
        this.objPrestamoMod = obj;
        this.txtFechaInicio.setText(obj.getFecha_inicio());
        this.txtFechaFinPrograma.setText(obj.getFecha_fin_programa());
        this.txtFechaEntregaReal.setText(obj.getFecha_entrega_real());
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        this.objPrestamoMod.setFecha_inicio(this.txtFechaInicio.getText());
        this.objPrestamoMod.setFecha_fin_programa(this.txtFechaFinPrograma.getText());
        this.objPrestamoMod.setFecha_entrega_real(this.txtFechaEntregaReal.getText());
        this.objPrestamoMod.setEstado(this.txtEstado.getText());
        this.objPrestamoMod.setPERSONAS_id(Integer.parseInt(this.txtPersonasId.getText()));
        this.objPrestamoMod.setACTIVOS_id(Integer.parseInt(this.txtActivosId.getText()));
        this.dispose();
    }
