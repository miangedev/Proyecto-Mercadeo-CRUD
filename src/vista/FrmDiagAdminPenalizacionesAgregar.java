...
public class FrmDiagAdminPenalizacionesAgregar extends javax.swing.JDialog {

    penalizacionprestamos objPenaliAdd;

    public FrmDiagAdminPenalizacionesAgregar(javax.swing.JFrame parent, boolean modal, penalizacionprestamos obj) {
        super(parent, modal);
        initComponents();
        this.objPenaliAdd = obj;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar Penalización");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        this.objPenaliAdd.setDias_retraso(Integer.parseInt(this.txtDiasRetraso.getText()));
        this.objPenaliAdd.setValor_penali(Double.parseDouble(this.txtValorPenali.getText()));
        this.objPenaliAdd.setFecha_generacion(this.txtFechaGeneracion.getText());
        this.objPenaliAdd.setPagada(Integer.parseInt(this.txtPagada.getText()));
        this.objPenaliAdd.setPRESTAMOS_ACTIVO_PERSONA_id(Integer.parseInt(this.txtPrestamoId.getText()));
        this.dispose();
    }
