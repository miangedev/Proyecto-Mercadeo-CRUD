...
public class FrmDiagAdminActivosAgregar extends javax.swing.JDialog {

    activos objActivoAdd;

    public FrmDiagAdminActivosAgregar(java.awt.Frame parent, boolean modal, activos obj) {
        super(parent, modal);
        initComponents();
        this.objActivoAdd = obj;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Agregar Activo");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        this.objActivoAdd.setNombre(this.txtNombre.getText());
        this.objActivoAdd.setTipo(this.txtTipo.getText());
        this.objActivoAdd.setMarca(this.txtMarca.getText());
        this.objActivoAdd.setModelo(this.txtModelo.getText());
        this.objActivoAdd.setAno_adquisicion(this.txtAnoAdquisicion.getText());
        this.objActivoAdd.setValor_comercial(Double.parseDouble(this.txtValorComercial.getText()));
        this.objActivoAdd.setEstado(this.txtEstado.getText());
        this.objActivoAdd.setCATEGORIAS_id(Integer.parseInt(this.txtCategoriasId.getText()));
        this.dispose();
    }
