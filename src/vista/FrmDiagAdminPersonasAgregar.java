...
public class FrmDiagAdminPersonasAgregar extends javax.swing.JDialog {

    personas objPersonaAdd;

    public FrmDiagAdminPersonasAgregar(javax.swing.JFrame parent, boolean modal, personas obj) {
        super(parent, modal);
        initComponents();
        this.objPersonaAdd = obj;
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {
        this.objPersonaAdd.setTipo_documento(this.txtTipoDocumento.getText());
        this.objPersonaAdd.setNumero_documento(this.txtNumeroDocumento.getText());
        this.objPersonaAdd.setRazon_social(this.txtRazonSocial.getText());
        this.objPersonaAdd.setTelefono(this.txtTelefono.getText());
        this.objPersonaAdd.setEmail(this.txtEmail.getText());
        this.objPersonaAdd.setDireccion(this.txtDireccion.getText());
        this.objPersonaAdd.setROL_id(Integer.parseInt(this.txtRolId.getText()));
        this.objPersonaAdd.setNombre(this.txtNombre.getText());
        this.dispose();
    }
